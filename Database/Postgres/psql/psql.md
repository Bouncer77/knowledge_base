...
\df     | Список функций
\dn     | Список пользовательских схем (или `SELECT nspname FROM pg_namespace;`) (describe namespace)
\dnS    | `\dn` + Системные схемы в текущей базе данных
...
Перенести таблицу из одной схемы в другую
